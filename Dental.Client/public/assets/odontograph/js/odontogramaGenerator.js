...
/**
 * Tight layout: minimal top margin, centered horizontally.
 * @param {HTMLCanvasElement} canvas
 * @param {number} toothCount teeth per arch row
 * @returns {{start: number, base: number}}
 */
OdontogramaGenerator.prototype.computeLayout = function (canvas, toothCount) {
    "use strict";
    var layoutCfg = (typeof window !== "undefined" && window.OdontographLayout) || null;
    var horizontalPad = layoutCfg ? layoutCfg.horizontalPad : 12;
    var topPad = layoutCfg ? layoutCfg.topPad : 48;
    var contentWidth = toothCount * this.imgWidth;
    var start = Math.max(horizontalPad, Math.floor((canvas.width - contentWidth) / 2));
    return { start: start, base: topPad };
};
...
OdontogramaGenerator.prototype.prepareOdontogramaAdult = function (odontograma,
    ...
    var layout = this.computeLayout(canvas, 16);
    ...
    for (var i = 18; i > 10; i--) {
        ...
        image.src = "/assets/odontograph/images/dentadura-sup-" + i + ".png";
    ...
    for (var i = 48; i > 40; i--) {
        ...
        image.src = "/assets/odontograph/images/dentadura-inf-" + i + ".png";
...
spaces, canvas) {
    ...
    var layout = this.computeLayout(canvas, 10);
    var start = layout.start;
    var x = start;
    var base = layout.base;
